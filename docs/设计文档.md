...
当前实现已在 HarmonyOS 6.1.1 / API 24 设备上执行 `persistsGatewaySessionWithHuks`：1 个用例通过，0 失败、0 错误；该用例实际覆盖 HUKS 密钥首次创建、AES-256-GCM 加密、Preferences 写入、HUKS 解密恢复和会话清理。
...
- HarmonyOS 6.1.1 / API 24：完成 HAP 构建、安装、首页布局和四大核心功能回归。
