...
自动化覆盖网关、协议、真实 TLS/WSS、安全负向、性能和短时稳定性；API 24 模拟器已验证 HUKS 会话保存和 APP 重启恢复。HarmonyOS 6.1.1 真机上的 HUKS 篡改拒绝、Native 控制互通、前后台切换和 30 分钟稳定性仍必须按 `../docs/测试报告.md` 补充实机证据。
